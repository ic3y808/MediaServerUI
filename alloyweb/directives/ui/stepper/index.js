...
export default function () {
  return {
    ...
    template:
      ...
      "    <button class=\"btn btn-default btn-sm\" type=\"button\" ng-disabled=\"isOverMin() || ngDisabled\" ng-click=\"decrement()\">-</button>" +
      "  </span>" +
      "  <input class=\"form-control\" type=\"text\" ng-model=\"ngModel\" ng-disabled=\"ngDisabled\" ng-changed=\"ngChanged\">" +
      "  <span class=\"input-group-btn\">" +
      "    <button class=\"btn btn-default btn-sm\" type=\"button\" ng-disabled=\"isOverMax() || ngDisabled\" ng-click=\"increment()\">+</button>" +
      "  </span>" +
      "</div>",
