...
ApplicationRun.$inject = ['$window', '$rootScope', 'MediaService', 'ChromecastService', 'SubsonicService'];

function ApplicationRun($window, $rootScope, MediaService, ChromecastService, SubsonicService) {
