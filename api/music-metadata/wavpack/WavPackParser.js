...
class WavPackParser extends BasicParser_1.BasicParser {
    ...
    parseWavPackBlocks() {
        return __awaiter(this, void 0, void 0, function* () {
            do {
                ...
                if (blockId !== 'wvpk')
                    break;
                const header = yield this.tokenizer.readToken(WavPack.BlockHeaderToken);
                ...
                if (header.blockIndex === 0 && header.blockSamples === 0) {
                    ...
                    yield this.parseMetadataSubBlock(ignoreBytes);
                }
                else {
    ...
    parseMetadataSubBlock(remainingLength) {
        return __awaiter(this, void 0, void 0, function* () {
            do {
                const id = yield this.tokenizer.readToken(WavPack.MetadataIdToken);
